<div class="container body">
  <div class="main_container" >
    <div class="col-md-3 left_col">
      <div class="left_col scroll-view" style="background-color: #5F9EA0 ">
        <div class="navbar nav_title" style="border: 0;">
          <a href="<?= base_url('admin'); ?>" class="site_title" style="background-color: #5F9EA0 "><i class="fa fa-desktop" ></i> <span>SPKomputer</span></a>
        </div>
        ...
        <div class="profile clearfix">
          ...
          <div class="profile_info">
            <span><h4>Selamat Datang</h4></span>
            <h2 style="font-weight: bold;">Asti Oktaviani</h2>
          </div>
          <div class="clearfix"></div>
        </div>
        <!-- /menu profile quick info -->
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu " >
          <div class="menu_section">
            <ul class="nav side-menu">
              <li><a class="text-" href="<?= base_url('admin'); ?>"><i class="fa fa-fw fa-home"></i> Dashboard</a></li>
