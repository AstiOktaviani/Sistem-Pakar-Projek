...
<head>
  <meta charset="utf-8" />
  <link rel="icon" type="image/png" href="<?= base_url('assets2'); ?>/img/.ico">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="example">
        ...
        <ul class="nav navbar-nav navbar-right" >
          <li>
            <a style="color: #000000" href="<?= base_url('member/index'); ?>" class="page-scroll">
              <i class="fa fa-home"></i>
              Home
            </a>
          </li>
          <li>
            <a style="color: #000000"  class="page-scroll" href="#">
              <i class="fa fa-user"></i>
              <?= $user['nama_user']; ?>
            </a>
          </li>
          <li>
            <a style="color: #000000" href="<?= base_url('auth'); ?>" onclick="return confirm('Yakin Keluar?');">
